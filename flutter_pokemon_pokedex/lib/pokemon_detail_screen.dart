...
class PokemonDetailScreen extends StatefulWidget {
  ...
  const PokemonDetailScreen({
    ...
    Key? key, // Add Key? key here if needed
  });
          ...
          Positioned(
            top: 70,
              ...
              child: Row(
                ...
                children: [
                  Text(widget.pokemonDetails['name'],style: TextStyle(color: Colors.white, fontSize: 30, fontWeight: FontWeight.bold), textAlign: TextAlign.left,),
                  Text("#" + widget.pokemonDetails['num'],style: TextStyle(color: Colors.white, fontSize: 20, ), textAlign: TextAlign.left,),
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Container(
                            width: width * 0.3,
                            child: Text(widget.pokemonDetails['weaknesses'].join(", "), style: TextStyle(color: Colors.black, fontSize: 15),),
                          ),
